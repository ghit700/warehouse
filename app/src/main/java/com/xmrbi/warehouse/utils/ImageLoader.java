...
public class ImageLoader {
     ...
     * 这里默认支持Context，GlideApp支持Context,Activity,Fragment，FragmentActivity
     */
...
//        GlideApp.with(mContext).load(path).asBitmap().into(mImageView);
//    }
//
//    //设置监听的用处 可以用于监控请求发生错误来源，以及图片来源 是内存还是磁盘
//
//    //设置监听请求接口
//    public static void loadImageViewListener(Context mContext, String path, ImageView mImageView, RequestListener<String, GlideAppDrawable> requstlistener) {
...
//
//    //设置要加载的内容
//    public static void loadImageViewContent(Context mContext, String path, SimpleTarget<GlideAppDrawable> simpleTarget) {
//        GlideApp.with(mContext).load(path).centerCrop().into(simpleTarget);
//    }
